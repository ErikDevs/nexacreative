...
const HeroSection = () => {
  return (
    <div className="justify-evenly  w-full px-6 lg:px-10 items-center mx-auto flex flex-col-reverse md:flex-row">
      ...
      <div className="w-96 h-96 bg-darkBlue absolute right-72 rounded-full -z-50"></div>
    </div>
  );
};
